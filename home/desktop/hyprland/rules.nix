{ ... }: {
  wayland.windowManager.hyprland.settings = {
    ...
    layerrule = [
      "match:namespace notifications, blur"
      "match:namespace notifications, abovelock true"
      "match:namespace waybar, blur"
      "match:namespace primary-bar, blur"
      "match:namespace ignis_bar_0, blur"
      "match:namespace ignis_bar_1, blur"
      "match:namespace ignis_bar_2, blur"
      "match:namespace ignis_bar_3, blur"
      "match:namespace waybar, abovelock true"
      "match:namespace primary-bar, abovelock true"
      "match:namespace ignis_bar_0, abovelock true"
      "match:namespace ignis_bar_1, abovelock true"
      "match:namespace ignis_bar_2, abovelock true"
      "match:namespace ignis_bar_3, abovelock true"
      "match:namespace rofi, blur"
      "match:namespace rofi, animation slidefadevert"
      "match:namespace wlroots, blur"
      "match:namespace gtk-layer-shell, blur"
      "match:namespace anyrun, blur"
      "match:namespace notifications, ignorezero"
      "match:namespace waybar, ignorezero"
      "match:namespace primary-bar, ignorealpha 0.45"
      "match:namespace ignis_bar_0, ignorezero"
      "match:namespace ignis_bar_1, ignorezero"
      "match:namespace ignis_bar_2, ignorezero"
      "match:namespace ignis_bar_3, ignorezero"
      "match:namespace rofi, ignorealpha 0.1"
      "match:namespace wlroots, ignorezero"
      "match:namespace gtk-layer-shell, ignorezero"
      "match:namespace anyrun, ignorezero"
      "match:namespace swaync-control-center, blur"
      "match:namespace swaync-notification-window, blur"
      "match:namespace swaync-notification-window, abovelock true"
      "match:namespace swaync-control-center, abovelock true"
      "match:namespace swaync-control-center, ignorezero"
      "match:namespace swaync-notification-window, ignorezero"
      "match:namespace swaync-control-center, ignorealpha 0.25"
      "match:namespace swaync-notification-window, ignorealpha 0.25"
    ];
    workspace = [
