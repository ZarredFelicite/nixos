{ ... }:
{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mod, J, exec, ~/scripts/sys/system rofi"
    ...
    binde = [
      ...
      " , XF86Prev_VMode, exec, /home/zarred/scripts/sys/media-select position -5"
      ...
      " , XF86Next_VMode, exec, /home/zarred/scripts/sys/media-select position +5"
