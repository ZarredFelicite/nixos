  ...
  programs.waybar = {
    ...
    settings = lib.mkMerge [
      ...
      primary = workspaces // {
        ...
        modules-center = [  ];
        modules-right = [ "hyprland/submap" "image#recording" "privacy" "group/zmk-battery" "group/airpods-battery"  "custom/weather" "custom/notification" "tray" "group/updates-group" "group/network-group" "group/volume-custom" "group/stats-group" "battery" "group/clock-group" "group/group-power" ];
        tray = {
          icon-size = 14;
          spacing = 3;
        };
