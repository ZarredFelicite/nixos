{ ... }: {
  wayland.windowManager.hyprland.settings = {
    ...
    layerrule = [
      ...
      "abovelock true, match:namespace notifications"
      ...
      "abovelock true, match:namespace waybar"
      "abovelock true, match:namespace primary-bar"
      "abovelock true, match:namespace ignis_bar_0"
      "abovelock true, match:namespace ignis_bar_1"
      "abovelock true, match:namespace ignis_bar_2"
      "abovelock true, match:namespace ignis_bar_3"
      ...
      "ignorezero, match:namespace notifications"
      "ignorezero, match:namespace waybar"
      "ignorealpha 0.45, match:namespace primary-bar"
      "ignorezero, match:namespace ignis_bar_0"
      "ignorezero, match:namespace ignis_bar_1"
      "ignorezero, match:namespace ignis_bar_2"
      "ignorezero, match:namespace ignis_bar_3"
      "ignorealpha 0.1, match:namespace rofi"
      "ignorezero, match:namespace wlroots"
      "ignorezero, match:namespace gtk-layer-shell"
      "ignorezero, match:namespace anyrun"
      "blur, match:namespace swaync-control-center"
      "blur, match:namespace swaync-notification-window"
      "abovelock true, match:namespace swaync-notification-window"
      "abovelock true, match:namespace swaync-control-center"
      "ignorezero, match:namespace swaync-control-center"
      "ignorezero, match:namespace swaync-notification-window"
      "ignorealpha 0.25, match:namespace swaync-control-center"
      "ignorealpha 0.25, match:namespace swaync-notification-window"
    ];
    workspace = [
