...
buildNpmPackage rec {
  ...
  installPhase = ''
    ...
    #mkdir -p /var/lib/private/homepage-dashboard
    cp -r .next/static /var/lib/private/homepage-dashboard/
    ln -fs /var/lib/private/homepage-dashboard/static $out/bin/.next/static
