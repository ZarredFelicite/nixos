...
The flake exposes the host configurations under `nixosConfigurations` (including `nano`, `web`, `sankara`, and `nano_minimal`). Host-specific hardware and Home Manager entry points live under `hosts/` and `home/hosts/`.
